...
public class NumberButton extends AbstractButton {
    ...
    public NumberButton(int number) {
        ...
        if (number == 0) {
            positionX = 3;
            positionY = Settings.getInstance().CALCULATOR_GRID_HEIGHT;
        } else if (number == 1) {
            positionX = 2;
            positionY = Settings.getInstance().CALCULATOR_GRID_HEIGHT - 1;
        } else if (number == 2) {
            positionX = 3;
            positionY = Settings.getInstance().CALCULATOR_GRID_HEIGHT - 1;
        } else if (number == 3) {
            ...
            positionX = 2;
            positionY = Settings.getInstance().CALCULATOR_GRID_HEIGHT - 2;
        } else if (number == 5) {
            positionX = 3;
            positionY = Settings.getInstance().CALCULATOR_GRID_HEIGHT - 2;
        } else if (number == 6) {
            ...
            positionX = 2;
            positionY = Settings.getInstance().CALCULATOR_GRID_HEIGHT - 3;
        } else if (number == 8) {
            positionX = 3;
            positionY = Settings.getInstance().CALCULATOR_GRID_HEIGHT - 3;
        } else if (number == 9) {
